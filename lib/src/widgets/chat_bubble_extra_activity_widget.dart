...
class ChatBubbleExtraActivityWidget extends StatefulWidget {
  const ChatBubbleExtraActivityWidget({
    required this.child,
  ...
  @override
  State<ChatBubbleExtraActivityWidget> createState() =>
      _ChatBubbleExtraActivityWidgetState();
}

class _ChatBubbleExtraActivityWidgetState
    extends State<ChatBubbleExtraActivityWidget>
